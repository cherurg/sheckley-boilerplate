...
/***/ function(module, exports) {
	...
	Gate = (function() {
	  function Gate(overContainer) {
	    ...
	    if (this.container.type === 'receiver' && (typeof socket !== "undefined" && socket !== null)) {
	      socket.on('plot-data', this.receive.bind(this));
	    }
	  }

	  Gate.prototype.send = function() {
	    if (!(this.container.type === 'sender' && (typeof socket !== "undefined" && socket !== null))) {
	      return;
	    }
	    return socket.emit('plot-data', this.container.getModel());
	  };
